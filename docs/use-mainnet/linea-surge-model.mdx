...
The _EA_ Multiplier will start at 1.5 at the beginning of the program and will be reduced at every end of each Volt till it will reach the value of 1 for the rest of the program:
